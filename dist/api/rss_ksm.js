...
function fetchReferendums() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield (0, node_fetch_1.default)('https://api.polkassembly.io/api/v1/latest-activity/all-posts?govType=open_gov&listingLimit=10', {
                method: 'GET',
                headers: {
                    'x-network': 'kusama',
            ...
            const now = new Date();
            const twentyFourHoursAgo = new Date(now.getTime() - 168 * 60 * 60 * 1000);
...
function fetchReferendumContent(postId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield (0, node_fetch_1.default)(`https://api.polkassembly.io/api/v1/posts/on-chain-post?postId=${postId}&proposalType=referendums_v2`, {
                method: 'GET',
                headers: {
                    'x-network': 'kusama',
                    'Content-Type': 'application/json'
            ...
            const postContent = yield response.json();
            return postContent;
        }
        catch (error) {
...
function fetchDotToUsdRate() {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        try {
            const response = yield (0, node_fetch_1.default)('https://api.coingecko.com/api/v3/simple/price?ids=kusama&vs_currencies=usd');
            if (!response.ok) {
                throw new Error(`Failed to fetch price data: ${response.statusText}`);
            }
            const data = yield response.json();
            return ((_a = data.kusama) === null || _a === void 0 ? void 0 : _a.usd) || 0; // Safely access USD value
        }
        catch (error) {
    ...
    const items = posts.map(post => {
        ...
        return `
            <item>
                ...
                <link>https://kusama.polkassembly.io/referenda/${post.post_id}</link>
